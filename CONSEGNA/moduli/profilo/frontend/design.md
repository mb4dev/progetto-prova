...
Il modulo **profilo** permette all'utente di visualizzare le proprie informazioni personali e di modificarle. Utilizza il pattern **Command** per gestire l'aggiornamento dei dati e invia notifiche globali tramite l'**EventBus** quando il profilo viene aggiornato, permettendo ad altri componenti (come l'header) di riflettere i cambiamenti istantaneamente.
...
classDiagram
    ...
    ProfilePresenter o-- ProfileUpdateCommand : config.onUpdateCommand
