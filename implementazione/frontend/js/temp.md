    ...
    alt verifica credenziali fallita
        ...
        alt Response 401/404/500
           ...
           backend -->> api : {success: true, token, user}
            ...
            presenter -->> app : route('/home')
            app -->> user : mostra home
        end
    end
...
sequenceDiagram
    ...
    user ->>+ view : Inserisce dati e clicca registrazione
    view ->>+ presenter:  new RegisterEvent(email, username, password)
    presenter ->> presenter : verifica dati
