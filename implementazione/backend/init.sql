...
CREATE TABLE prenotazioni (
    ...
    data DATE NOT NULL,
    slot_start TIME NOT NULL,CREATE SCHEMA IF NOT EXISTS centro_sportivo;
...
INSERT INTO prenotazioni (user_id, tipo, campo_id, data, slot_start) VALUES
(1, 'campo', 2, '2026-01-22', '10:00'),
(1, 'campo', 2, '2026-01-23', '14:00'),
(1, 'campo', 1, '2026-01-23', '14:00'),
(2, 'campo', 1, '2026-01-23', '14:30'),
(2, 'campo', 3, '2026-01-24', '09:00'),
(1, 'campo', 4, '2026-01-25', '11:00');

INSERT INTO prenotazioni (user_id, tipo, corso_id, data, slot_start) VALUES
(1, 'corso', 2, '2026-01-26', '16:00'),
(2, 'corso', 2, '2026-01-26', '16:00'),
(1, 'corso', 2, '2026-01-26', '14:00'),
(3, 'corso', 1, '2026-01-26', '16:00');
